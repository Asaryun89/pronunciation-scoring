...
from utils.prosody import basic_prosody_features
...
class PronunciationPredictor:
    ...
    def predict(self, wav_path: str, language: str = "en") -> Dict[str, Any]:
        ...
        # ---- 4. Prosody features (for metadata) ----
        ...
        # ---- 8. Build word output list (timestamps only — no word-level scoring) ----
