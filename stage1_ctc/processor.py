...
from .config import SAMPLING_RATE, VOCAB_PATH
...
def build_vocab(dataset, vocab_path: str = VOCAB_PATH):
...
def get_processor(vocab_path: str = VOCAB_PATH) -> Wav2Vec2Processor:
